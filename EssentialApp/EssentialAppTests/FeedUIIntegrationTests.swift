...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        sut.loadViewIfNeeded()
        sut.replaceRefreshControlWithFakeForiOSSupport()
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once view is loaded")

        sut.beginAppearanceTransition(true, animated: false)
        sut.endAppearanceTransition()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator when the view is appearing")
    ...
    func test_loadFeedCompletion_rendersSuccesfullyLoadedEmptyFeedAfterNonEmptyFeed() {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url], "Expected once cancelled image URL request once image is not visible anymore")

        sut.simulateFeedImageViewNotVisible(at: 1)
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected two cancelled image URL requests once second image is also not visible anymore")
    }

    func test_feedImageViewLoaidngIndicator_isVisibleWhileLoadingImage() {
        let (sut, loader) = makeSUT()
